<?php
/**
 * Sophia\Base_Support\Component class
 *
 * @since 1.0.0
 *
 * @package Sophia
...
class Component implements Component_Interface, Templating_Component_Interface {
    ...
    public function initialize()
    {
        ...
        add_action( 'wp_head', [ $this, 'actionAddPingbackHeader' ] );
        add_filter( 'body_class', [ $this, 'filterBodyClassesAddHfeed' ] );
     ...
     */
    public function actionAddPingbackHeader()
    {
     ...
     */
    public function filterBodyClassesAddHfeed( array $classes ) : array
    {
        if ( ! is_singular() ) {
            $classes[] = 'hfeed';
        }
